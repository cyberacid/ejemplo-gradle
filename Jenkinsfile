    ...
    stages {
        stage("Pipeline"){
            ...
            post{
                ...
                failure{
                    slackSend channel: 'U02MXGDEZT5', color: 'danger', message: "[Fernando Peña] [${env.JOB_NAME}] [${BUILD_TAG}] Ejecucion fallida en stage [${env.STAGE_NAME}]", teamDomain: 'dipdevopsusac-tr94431', tokenCredentialId: 'slack'
                }
            }
        }
    }
